...
public class HepsiBurada {
    ...
    public void Touch() throws MalformedURLException, InterruptedException {
        ...
        desiredCapabilities.setCapability(MobileCapabilityType.APP, "C:\\Users\\Mehmet\\Desktop\\appiumNew11\\src\\test\\java\\AppiumClassFirst\\APP\\hepsiburada.apk");
        Thread.sleep(5000);
  ...
  WebElement popup= driver.findElementById("com.pozitron.hepsiburada:id/textViewLocation");
  popup.click();
/*
  WebElement konum=driver.findElementById("com.pozitron.hepsiburada:id/textViewTitle");
  konum.click();


        WebElement il=driver.findElementByXPath("//android.widget.TextView[@content-desc=\"İl seçin\"]");
        il.click();
       WebElement istanbul= driver.findElementByAndroidUIAutomator("new UiScrollable(new UiSelector()).scrollIntoView(text(\"İstanbul\"));");
        istanbul.click();
